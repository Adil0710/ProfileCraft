...
export function HowWorks() {
  return (
    <div className=" bg-white flex justify-center items-center dark:bg-black py-10">
      <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2 max-w-6xl">
        <BentoCard
          eyebrow="Insight"
          ...
          graphic={
            ...
            <AnimatedBeamMultipleOutput className="bg-white dark:bg-gray-950 absolute right-0 top-0 h-full rounded-none border-none transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_-10%,#000_-50%)] group-hover:scale-105" />
          }
          fade={["bottom"]}
